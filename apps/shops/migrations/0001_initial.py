    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_price', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Mahsulotning umumiy narxi')),
                ('purchase_price', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Mahsulotning sotib olish narxi')),
                ...
                ('quantity', models.IntegerField(db_default=0, verbose_name='mahsulot soni status indefinite bo`lganda chiqadi')),
